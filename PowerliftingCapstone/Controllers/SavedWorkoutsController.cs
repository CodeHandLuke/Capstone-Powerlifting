...
namespace PowerliftingCapstone.Controllers
{
    public class SavedWorkoutsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SavedWorkoutId,Date,Exercise,OneRMPercentage,Reps,Weight,WorkoutId,UserId")] SavedWorkout savedWorkout)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SavedWorkoutId,Date,Exercise,OneRMPercentage,Reps,Weight,WorkoutId,UserId")] SavedWorkout savedWorkout)
        {
            if (ModelState.IsValid)
            {
